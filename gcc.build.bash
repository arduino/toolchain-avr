...
if [[ ! -f gcc-4.9.2.tar.bz2 ]] ;
then
	wget http://mirror.switch.ch/ftp/mirror/gnu/gcc/gcc-4.9.2/gcc-4.9.2.tar.bz2
fi

tar xfv gcc-4.9.2.tar.bz2
...
mv gmp-5.0.2 gcc-4.9.2/gmp
mv mpfr-3.0.0 gcc-4.9.2/mpfr
mv mpc-0.9 gcc-4.9.2/mpc
...
CFLAGS="-w -O2 -g0 $CFLAGS" CXXFLAGS="-w -O2 -g0 $CXXFLAGS" LDFLAGS="-s $LDFLAGS" ../gcc-4.9.2/configure $CONFARGS
